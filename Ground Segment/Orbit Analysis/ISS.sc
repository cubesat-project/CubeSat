...
BEGIN Scenario
    ...
    BEGIN Epoch
        ...
        Epoch		 1 Jul 2021 16:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 1 Jul 2021 16:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 1 Jul 2021 16:00:00.000000000
        Stop		 1 Jul 2022 16:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 1 Jul 2021 16:00:00.000000000
    ...
    BEGIN QuickReports
        ...
        BEGIN Report
            ...
            Style		 Access
            AGIViewer		 Yes
            Instance		 Satellite/ISS_UNITY_25575
            BEGIN InstanceList
        ...
        BEGIN Report
            ...
            WindowRectBottom		 836
        END Report

        BEGIN Report
            Name		 Eclipse Summary
            Type		 Report
            BaseDir		 Install
...
"1 Jul 2021 16:00:00.000000000" "1 Jul 2022 16:00:00.000000000"
                        END Intervals
...
"1 Jul 2021 16:00:00.000000000" "1 Jul 2022 16:00:00.000000000"
        ...
        BEGIN Report
            ...
            WindowRectLeft		 378
            WindowRectTop		 195
            WindowRectRight		 1279
            WindowRectBottom		 632
        END Report
...
"1 Jul 2021 16:00:00.000000000" "1 Aug 2021 16:00:00.000000000"
                        END Intervals
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 -1.1543e+08
            LaunchWindowStop		 -1.4688e+08
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 3 Nov 2017 16:00:00.000000000
                    Stop		 4 Nov 2017 16:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
...
<VAR name = "STK_Radar_Clutter_Extension">
    <SCOPE Class = "RadarClutterExtension">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 1 Jul 2021 16:00:00.000000000
                EndTime		 1 Jul 2022 16:00:00.000000000
                CurrentTime		 1 Jul 2021 16:00:00.000000000
                Direction		 Forward
                UpdateDelta		 10
            ...
            BEGIN MapData
                ...
                BEGIN Map
                    ...
                    BEGIN MapAttributes
                        PrimaryBody		 Earth
                        SecondaryBody		 Sun
                        CenterLatitude		 -0.2171290711700844
                        CenterLongitude		 -0.5784082539941551
                        ...
                        BEGIN ZoomLocations
                            BEGIN ZoomLocation
                                CenterLat		 -0.2171290711700844
                                CenterLon		 -0.5784082539941551
                                ZoomWidth		 360
                                ZoomHeight		 180
                            END ZoomLocation
                        END ZoomLocations
    ...
    BEGIN References
        Instance *
            *		
        END Instance
        Instance Facility/Dublin_IR
            Facility/Dublin_IR		
        END Instance
        Instance Facility/Edmonton
            Facility/Edmonton		
        END Instance
        Instance Facility/Halifax
            Facility/Halifax		
        END Instance
        Instance Facility/Iqaluit
            Facility/Iqaluit		
        END Instance
        Instance Facility/London
            *		
            Facility/London		
        END Instance
        Instance Facility/Montreal
            Facility/Montreal		
        END Instance
        Instance Facility/Saskatoon
            Facility/Saskatoon		
        END Instance
        Instance Facility/St_Johns
            Facility/St_Johns		
        END Instance
        Instance Facility/Victoria
            Facility/Victoria		
        END Instance
        Instance Facility/Wellington_NZ
            Facility/Wellington_NZ		
        END Instance
        Instance Facility/Winnipeg
            Facility/Winnipeg		
        END Instance
        Instance Satellite/ISS_UNITY_25575
            *		
            Satellite/ISS_UNITY_25575		
        END Instance
    END References
