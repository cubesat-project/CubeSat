function[] = Cube3Dz(final464,final542,final639,final669,final708,final800,final845)
...
% Note I also changed it so the
% information of my images now display on the x-y axis, and it iterates
% through i number of Z slices 
for i = 1:1:7
    N(:,:,i) = M(:,8-i,:);
end
...
%speficy grayscale (i wanted grayscale images, you can change your
%coloring)
colormap(gray);

%specify the opacity of the cubing (1 = no opacity [all solid], 0 = translucent)
...
%reverse order
zticklabels({'845','800','708','669','639','542','464'});
